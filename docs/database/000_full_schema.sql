...
CREATE TABLE IF NOT EXISTS users (
  ...
  role VARCHAR(10) DEFAULT 'user' CHECK (role IN ('admin', 'user', 'jh01', 'ji01')),
...
CREATE TABLE IF NOT EXISTS accounts (
  ...
  user_id INT NOT NULL,
  name VARCHAR(100) NOT NULL,
  type VARCHAR(20) NOT NULL CHECK (type IN ('savings', 'checking', 'cash', 'investment', 'credit_card', 'other')),
